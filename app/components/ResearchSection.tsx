      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 240 }}>
            ...
            >
              Опрос показал, что большинство девятиклассников имеют низкий уровень киберграмотности — особенно в вопросах защиты аккаунтов и распознавания ИИ-угроз. После проведения урока и ознакомления с данным проектом показатели значительно улучшились. Это подтверждает гипотезу: регулярное образование по кибербезопасности эффективно снижает риски для подростков.
            </p>
          </div>
        </div>
      </div>
